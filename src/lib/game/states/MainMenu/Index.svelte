<script lang="ts">
	import Play from '$lib/game/states/MainMenu/Play.svelte'
	import Dictionaries from '$lib/game/states/MainMenu/Dictionaries.svelte'
	import Settings from '$lib/game/states/MainMenu/Settings.svelte'
